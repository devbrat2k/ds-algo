package com.devbrat2k.ds.linklist.question.binaryToDecimal;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Convert 1011 to 11
        // ---------------
        B2DLinkedList list1 = new B2DLinkedList(1);
        list1.append(0);
        list1.append(1);
        list1.append(1);
        ...
        // Convert 1100 to 12
        // ---------------
        B2DLinkedList list2 = new B2DLinkedList(1);
        list2.append(1);
        list2.append(0);
        list2.append(0);
        ...
        // Convert 1 to 1
        // ---------------
        B2DLinkedList list3 = new B2DLinkedList(1);
        ...
        // ---------------
        B2DLinkedList list4 = new B2DLinkedList(0);
        list4.makeEmpty();
